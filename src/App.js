...
function Create({ setIsChanged }) {
  ...
  const postTodo = () => {
    axios
      .post("https://todo-backend-zqp2.onrender.com/todo", { todo: todo })
...
function App() {
  ...
  useEffect(() => {
    axios
      .get("https://todo-backend-zqp2.onrender.com/todo")
      .then((result) => setTodos(result.data))
      .catch((err) => console.log(err));
  }, [isChanged]);
  const handleDelete = (id) => {
    axios
      .delete("https://todo-backend-zqp2.onrender.com/todo/" + id)
  ...
  const handleEdit = (id, isDone) => {
    axios
      .put("https://todo-backend-zqp2.onrender.com/todo/" + id, {
        isDone: !isDone,
      })
